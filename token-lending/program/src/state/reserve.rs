...
pub struct ReserveLiquidity {
    ...
    /// Reserve liquidity oracle (Pyth product) account
    pub oracle_pubkey: Pubkey,
    /// Reserve liquidity price (Pyth price) account
...
impl ReserveLiquidity {
    ...
    pub fn new(params: NewReserveLiquidityParams) -> Self {
        Self {
            ...
            price_pubkey: params.price_pubkey,
            available_amount: 0,
...
const RESERVE_LEN: usize = 595; // 1 + 8 + 1 + 32 + 32 + 1 + 32 + 32 + 32 + 32 + 16 + 8 + 8 + 16 + 32 + 32 + 8 + 1 + 1 + 1 + 1 + 1 + 1 + 1 + 8 + 8 + 1 + 248
impl Pack for Reserve {
    ...
    fn pack_into_slice(&self, output: &mut [u8]) {
        ...
        *liquidity_mint_decimals = self.liquidity.mint_decimals.to_le_bytes();
        ...
        liquidity_price_pubkey.copy_from_slice(self.liquidity.price_pubkey.as_ref());
    ...
    fn unpack_from_slice(input: &[u8]) -> Result<Self, ProgramError> {
        ...
        Ok(Self {
            ...
            liquidity: ReserveLiquidity {
                ...
                price_pubkey: Pubkey::new_from_array(*liquidity_price_pubkey),
