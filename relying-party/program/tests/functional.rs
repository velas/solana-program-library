...
fn program_test() -> ProgramTest {
    ProgramTest::new("vlx-relying-party", id(), processor!(process_instruction))
}
...
async fn initialize_success() {
    ...
    let program_icon_cid: [u8; 64] = "d2a84f4b8b650937ec8f73cd8be2c74add5a911ba64df27458ed8229da804a26".as_bytes().try_into().unwrap();
